...
class Rcheck extends CI_Controller {
	...
	public function index()
	{
        ...
        $orgCheck = $db2->query("SELECT e.CatgID,e.ChainId, e.ONo, e.Name, e.CountryCd, c.StTime, c.CloseTime, e.EType, e.Logo,  c.CustOrgs, c.MultiKitchen, c.MultiScan, c.kds, c.AutoAllot, c.AutoDeliver, c.SchPop, c.SchType, c.ServChrg, c.Tips, c.EDT, c.TableReservation ,c.Deliver, c.CustAssist, c.TableAcceptReqd, c.BillMergeOpt, c.billSplitOpt, c.AutoSettle,c.Dispense_OTP,c.DelCharge, c.Charity, c.CharityCharge, c.Ing_Cals, c.NV, c.Ingredients, c.WelcomeMsg,c.Ent,c.MultiLingual,c.MultiPayment,c.pymtENV, c.CustLoyalty, c.Discount FROM Config c, Eatary e where e.EID = $EID and e.EID = c.EID")->row_array();
        $dd = $_REQUEST['t'];
        $tblStr = "'$dd'";
        $session_data = array(
            'EID' => $_REQUEST['e'],
