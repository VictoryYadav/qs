...
class Cust extends CI_Model{
	...
	function getItemDetailLists($CID, $mcat, $fl){
		...
		$langId = $this->session->userdata('site_lang');
        $lname = "mi.Name$langId as itemName";
