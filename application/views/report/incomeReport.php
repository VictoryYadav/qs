                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="fromDate" id="fromDate" class="form-control form-control-sm" onchange="incomeData()"  value="<?= $fromDate; ?>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="toDate" id="toDate" class="form-control form-control-sm" onchange="incomeData()" value="<?= date('Y-m-d'); ?>"/>
                                                    </div>
                                                </div>
