                                            ...
                                            <table id="tblData" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $row['Rank']; ?></td>
                                                        <td>
                                                            <button class="btn btn-sm btn-rounded btn-warning" onclick="editData(<?= $row['EID'] ?>,<?= $row['CID'] ?>,<?= $row['KitCd'] ?>, <?= $row['Rank'] ?>,<?= $row['MCatgId'] ?>,'<?= $row['MCatgNm'] ?>')">
...
editData = (eid, cid, kitcd, rank, MCatgId, name) => {
...
$('#menuCatForm').on('submit', function(e){
    ...
    $.post('<?= base_url('restaurant/edit_menu_category') ?>',data,function(res){
