  ...
  <div id="invoice-POS">
    ...
    <div>
      <table style="font-size: 18px;">
        ...
        <?php } ?>
        <tr style="border-bottom: 1px solid black;">
          <td style="text-align: left;">Bill No: <?= $billno ?> <?php if($this->session->userdata('billPrintTableNo') > 0 && $OType < 100) { echo ",    Table No: ".$TableNo; } ?><br>
            Date: <?= $dateOfBill ?>
          </td>
          <?php if ($CustNo != "0") : ?>
                        ...
                        if( $value['TaxType'] != $TaxType || $key == 0){
                            ...
                            $std = '';
                              if($data['Portions'] != 'Std'){
                                ...
                                if(!empty($data['CustItemDesc']) && $data['CustItemDesc'] != 'Std'){
