...
<script type="text/javascript">
    ...
    var OType = $('#order-type').val();
        ...
        $('#customOfferForm').on('submit', function(e){
            ...
            $.post('<?= base_url('restaurant/update_customItem_onTempKitchen') ?>',{ItemId:ItemId, OrdNo:ordNo, CustItemDesc:custOfferName.join(", "), ItemRates:custOfferAmountView, OrigRates:kitOrigRate, custItemIds:custItemIds},function(res){
                if(res.status == 'success'){
                    getTableData();
