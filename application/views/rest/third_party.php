                                            ...
                                            <table id="TableData" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-sm btn-rounded btn-warning" onclick="editData(<?= $row['3PId'] ?>, '<?= $row['LngName'] ?>', <?= $row['Stat'] ?>)">
...
<script type="text/javascript">
    ...
    $('#thirdPartyForm').on('submit', function(e){
        ...
        $.post('<?= base_url('restaurant/third_party_list') ?>',data,function(res){
    ...
    function editData(PId,name, stat){
