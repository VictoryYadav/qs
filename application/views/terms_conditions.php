...
<body>
    ...
    <section class="common-section p-2 dashboard-container">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3>EatOut - Terms of Use</h3>


This document is an electronic record in terms of Information Technology Act, 2000 and rules there under as applicable and the amended provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of www.EatOut.com website and EatOut application for mobile and handheld devices.<br>


Terms of Use
<br>

These terms of use (the "Terms of Use") govern your use of our website www.EatOut.com (the "Website") and our "EatOut" application for mobile and handheld devices (the "App"). The Website and the App are jointly referred to as the "Platform". Please read these Terms of Use carefully before you use the services. If you do not agree to these Terms of Use, you may not use the services on the Platform, and we request you to uninstall the App. By installing, downloading or even merely using the Platform, you shall be contracting with EatOut and you signify your acceptance to this Terms of Use and other EatOut policies (including but not limited to the Cancellation & Refund Policy, Privacy Policy and Take Down Policy) as posted on the Platform and amended from time to time, which takes effect on the date on which you download, install or use the Platform, and create a legally binding arrangement to abide by the same.

The Platform is owned and operated by Bundl Technologies Private Limited, a private limited company incorporated under the Companies Act, 1956 and having its registered office at No.55, Sy No.8-14, Ground Floor, I&J Block, Embassy Tech Village, Outer Ring Road, Devarbisanahalli, Bengaluru – 560103, Karnataka, India. For the purpose of these Terms of Use, wherever the context so requires, "you", “user”, or “User” shall mean any natural or legal person who shall transaction on the Platform by providing registration data while registering on the Platform as a registered user using any computer systems. The terms "EatOut", "we", "us" or "our" shall mean Bundl Technologies Private Limited.

EatOut enables transactions on its Platform between participating restaurants/merchants and buyers, dealing in (a) prepared food and beverages, (b) consumer goods, and (c) other products and services ("Platform Services"). The buyers ("Buyer/s") can choose and place orders ("Orders") from a variety of products and services listed and offered for sale by various merchants including but not limited to the restaurants, eateries and grocery stores ("Merchant/s"), on the Platform. Further, the Buyer can also place Orders for undertaking certain tasks on the Platform (“Tasks”). 

EatOut enables delivery of such Orders or completion of Tasks at select localities of serviceable cities across India ("Delivery Services") by connecting third party service providers i.e. pick-up and delivery partners (“PDP”) who will be responsible for providing the pick-up and delivery services and completing Tasks initiated by the users of the Platform (Buyers or Merchants). The Platform Services and Delivery Services are collectively referred to as "Services". For both Platform Services and Delivery Services, EatOut is merely acting as an intermediary between the Merchants and Buyers and/or PDPs and Buyers/Merchants.

PDPs are individual entrepreneurs engaged with EatOut on a voluntary, non-exclusive and principal to principal basis to provide aforementioned services for service fee. PDPs are independent contractors and are free to determine their timings of work.  EatOut does not exercise control on the PDPs and the relationship between the PDPs and EatOut is not that of an agent and principal or employee and employer. 
...
These Terms of Use are subject to modifications. We reserve the right to modify or change these Terms of Use and other EatOut policies at any time by posting modified documents on the Platform and notifying you of the same for your perusal. You shall be liable to update yourself of such changes, if any, by accessing the same. You shall, at all times, be responsible for regularly reviewing the Terms of Use and the other EatOut policies and note the changes made on the Platform. Your continued usage of the Services after any change is posted constitutes your acceptance of the amended Terms of Use and other EatOut policies. As long as you comply with these Terms of Use, EatOut grants you a personal, non-exclusive, non-transferable, limited privilege to access, enter, and use the Platform. By accepting these Terms of Use, you also accept and agree to be bound by the other terms and conditions and EatOut policies (including but not limited to Cancellation & Refund Policy, Privacy Policy and Notice and Take Down Policy) as may be posted on the Platform from time to time.


Use of Platform and Services

All commercial/contractual terms are offered by and agreed to between Buyers and Merchants alone with respect to products and services being offered by the Merchants. The commercial/contractual terms include without limitation price, applicable taxes, shipping costs, payment terms, date, period and mode of delivery, warranties related to products and services and after sales services related to products and services. EatOut does not have any control or does not determine or advise or in any way involve itself in the offering or acceptance of such commercial/contractual terms between the Buyers and Merchants. EatOut may, however, offer support services to Merchants in respect to Order fulfilment, mode of payment, payment collection, call centre support and other ancillary services, pursuant to independent contracts executed by EatOut with the Merchants. The price of the product and services offered by the Merchant are determined by the Merchant itself and EatOut has no role to play in such determination of price in any way whatsoever.

Upon acceptance of any Order or Task by the PDPs, the pickup and delivery services or Task completion services (as the case may be) undertaken by him/her, shall constitute a separate contract for services between Merchants/Buyers and PDPs. EatOut shall not be responsible for the services provided by PDP to Merchants/Buyers through the Platform. EatOut may, however, offer support services to PDPs in respect of Order fulfilment, payment collection, call centre support, and other ancillary services, pursuant to independent contracts executed by EatOut with the PDPs.

EatOut does not make any representation or warranty as to the item-specifics (such as legal title, creditworthiness, identity, etc.) of any of the Merchants. You are advised to independently verify the bona fides of any particular Merchant that you choose to deal with on the Platform and use your best judgment on that behalf. All Merchant offers and third-party offers are subject to respective party terms and conditions. EatOut takes no responsibility for such offers.

EatOut neither make any representation or warranty as to specifics (such as quality, value, salability, etc.) of the products or services proposed to be sold or offered to be sold or purchased on the Platform nor does implicitly or explicitly support or endorse the sale or purchase of any products or services on the Platform. EatOut accepts no liability for any errors or omissions, whether on behalf of itself or third parties.

EatOut does not make any representation or warranty with respect to any aspect of the services being provided by the PDPs through the Platform including but not limited to pick up and delivery services and Task completion services to the Merchants or Buyers as the case may be.

EatOut is not responsible for any non-performance or breach of any contract entered into between Buyers and Merchants, and between Merchants/Buyers and PDP on the Platform. EatOut cannot and does not guarantee that the concerned Buyers, Merchants and PDPs will perform any transaction concluded on the Platform. EatOut is not responsible for unsatisfactory or non-performance of services or damages or delays as a result of products which are out of stock, unavailable or back ordered.

EatOut is operating an online marketplace and assumes the role of facilitator, and does not at any point of time during any transaction between Buyer and Merchant and/or Buyer and PDP on the Platform come into or take possession of any of the products or services offered by Merchant or PDP. At no time shall EatOut hold any right, title or interest over the products nor shall EatOut have any obligations or liabilities in respect of such contract entered into between Buyer and Merchant and/or Buyer and PDP.

EatOut is only providing a platform for communication and it is agreed that the contract for sale of any of the products or services shall be a strictly bipartite contract between the Merchant and the Buyer. In case of complaints from the Buyer pertaining to efficacy, quality, or any other such issues, EatOut shall notify the same to Merchant and shall also redirect the Buyer to the consumer call center of the Merchant. The Merchant shall be liable for redressing Buyer complaints. In the event you raise any complaint on any Merchant accessed using our Platform, we shall assist you to the best of our abilities by providing relevant information to you, such as details of the Merchant and the specific Order to which the complaint relates, to enable satisfactory resolution of the complaint.

Similar to the above, EatOut is only providing a platform for communication with PDP and does not provide any pick-up and delivery services or Task completion services with respect to the Orders placed by Merchants/Buyers on the Platform as it is merely facilitating Delivery Services by connecting the Merchants/Buyers with the PDP through the Platform. In case of complaints by the Merchants/Buyers for deficiency or lapse in the delivery services or Task completion services provided by PDP, EatOut shall notify the same to the PDP and also assist Merchants/Buyers to the best of its abilities to enable satisfactory resolution of the complaint. 

Please note that there could be risks in dealing with underage persons or people acting under false pretence.

EatOut - Use of the Website and Apps (Android and iOS)
...
engages in commercial activities and/or sales without our prior written consent such as contests, sweepstakes, barter, advertising and pyramid schemes, or the buying or selling of products related to the Platform. Throughout these Terms of Use, EatOut's prior written consent means a communication coming from EatOut's Legal Department, specifically in response to your request, and expressly addressing and allowing the activity or conduct for which you seek authorization;
...
You may not use the Platform or any content on the Platform for any purpose that is unlawful or prohibited by these Terms of Use, or to solicit the performance of any illegal activity or other activity that infringes the rights of EatOut and/or others.
...
Depending on the Third Party Accounts, you choose, and subject to the privacy settings that you have set in such Third Party Accounts, personally identifiable information that you post to your Third Party Accounts will be available on and through your EatOut Account on the Platform.
...
We reserve the right to suspend or terminate your EatOut Account and your access to the Services (i) if any information provided during the registration process or thereafter proves to be inaccurate, not current or incomplete; (ii) if it is believed that your actions may cause legal liability for you, other users or us; and/or (iii) if you are found to be non-compliant with the Terms of Use or other EatOut policies.

You are responsible for safeguarding your password. You agree that you will not disclose your password to any third party and that you will take sole responsibility for any activities or actions under your EatOut Account, whether or not you have authorized such activities or actions. You will immediately notify us of any unauthorized use of your EatOut Account.
...
The Platform allows the Buyers to place Orders and upon acceptance of such Orders by the Merchants, EatOut will, subject to the terms and conditions set out herein, facilitates delivery of goods or services, or completion of Tasks through PDP.

EatOut does not own, sell, resell on its own such products offered by the Merchants, and/or does not control the Merchants or the related services provided in connection thereof. Buyer understands that any Order that he/she places shall be subject to the terms and conditions set out in these Terms of Use including, but not limited to, product availability, delivery location serviceability, and acceptance of Orders by Merchants/PDPs.
...
The final tax bill will be issued by the Merchant and PDP (if registered for tax purposes) to the Buyer along with the Order and EatOut is merely collecting the payment on behalf of such Merchant and PDP. All applicable taxes and levies, the rates thereof and the manner of applicability of such taxes on the bill are being charged and determined by the Merchant and PDP. EatOut holds no responsibility for the legal correctness/validity of the levy of such taxes. The sole responsibility for any legal issue arising on the taxes shall reside with the Merchant and the PDP.
...
In order to continually improve and provide you/ Buyer with a seamless experience we need to ensure maintenance and upkeep of our application/platform. For such upkeep and maintenance, we may, charge a nominal non-refundable amount from you/Buyer as ‘platform fees’.
...
The Merchant shall be solely responsible for any warranty/guarantee of the goods or services sold to the Buyers and in no event shall be the responsibility of EatOut.

The transactions are bilateral between the Merchant and Buyer, and between Merchant/Buyer and PDP, therefore, EatOut is not liable to charge or deposit any taxes applicable on such transactions. 
...
The Buyer agrees and acknowledges that EatOut shall not be responsible for:
...
The details of the menu and price list available on the Platform with respect to restaurant services, goods or any other services are based on the information provided by the Merchants and EatOut shall not be responsible for any change or cancellation or unavailability.

Buyers and Merchants agree and acknowledge that EatOut is not responsible for any liability arising out of delivery services provided by PDP to them.

Buyers may not be able to avail Services if their delivery location is outside EatOut’s current scope of Service. EatOut will keep the Buyer informed of the same at the time of confirming his/her Order booking.

Buyer understands that delivery time quoted at the time of confirming the Order is an approximate estimate and may vary based on the information obtained from PDPs and Merchants. EatOut will not be responsible for any delay in the delivery of an Order.

Buyer understands that there are certain Merchants who undertake delivery of their goods and services to the Buyer and the Merchant may charge the Buyer for such service. EatOut exercises no control on such delivery services and same shall be under the control of Merchant alone and hence all or any disputes arising out of such delivery services shall be between Buyer and Merchant alone. EatOut shall not be responsible for such delivery services and assumes no liability for disputes arising out of the same.
...
The Buyer understands that EatOut’s (including Merchant’s and PDP’s) liability ends once Order has been delivered to him/her, except where the product liability of the Merchant subsists. 

Services provided:

You agree and acknowledge that EatOut shall not be liable for any damages, losses or claims to You or any third party in the event you have failed to adhere to the Terms of Use.
...
EatOut does not offer any refunds against goods or services already purchased from a Merchant or PDP through the Platform unless an error that is directly attributable to EatOut has occurred during the purchase of such product or services.
...
Buyer understands and agrees that EatOut’s Platform is merely a technology platform and the medicines and pharmaceutical products are sold by the Merchant. EatOut shall not be held responsible in any manner for any error or omission or act committed on part of the Merchant.

Buyer agrees and undertakes that he/she will not repeat the use of prescription for which drugs have already been dispensed. In case a Buyer found repeating the use of prescription, the Order will be cancelled immediately. In any event, EatOut shall not be responsible for any adverse effects or harm caused to Buyer.
...
The Merchant/EatOut may maintain a record of the prescriptions uploaded by the Buyers.
...
Delivery Address: The Buyer agrees and undertakes that he/she will not provide the address of any public place including but not limited to educational institution, hospital, religious places as delivery address for the Order. If the delivery address is found to be the address of a public place, EatOut reserves the right to immediately cancel the Order without being liable to process any refund.

Please refer to the Cancellation and Refund Policy for cancellation and refunds terms in relation to usage of the Platform for availing Services.  

Specific Terms with respect to Use of Platform for availing Services of EatOut Genie 

The pick-up and drop off services are offered by and agreed to between the Users and the PDP alone. EatOut assumes the role of facilitator only and EatOut merely provides a Platform to facilitate pick-up and drop off services between PDP and Users.  At no point of time, EatOut shall be held responsible or liable for any transactions between Users and PDP and for the services offered by PDP.

The PDP will provide services as per your sole instructions. EatOut does not have any control or does not determine or advise or in any way involve itself in the offering or acceptance of such services to be provided by the PDP to the User.

You agree that the details of the items for pick-up and drop or concierge services, and the pick-up and drop location are provided or entered by you in the Platform, in accordance with which the PDP will render the services and perform the Task. EatOut shall not be held responsible for any issues concerning the Task as the same is performed by the PDP as per your sole instructions and/or the details provided by you.
...
In the event of you requesting transportation of any illegal or unlawful or prohibited items as mentioned above or which is otherwise restricted under any applicable law, EatOut has the right to report the same to the law enforcement authorities.

In the event, during transit of your item(s) from pick-up location to drop-off location or while undertaking concierge services, if police or other law enforcement agencies demand for display of the item(s) for verification, the PDP shall have the right to display the item(s) to such authorities. 

You agree and undertake that you shall abstain from sending high value item(s) whilst using the Services through the Platform and if you use the Services to send any high value item, it shall be at your own risk only and EatOut shall not be held responsible for loss or any damage caused to such item(s). It is your sole responsibility to insure the items(s) to cover the risk of loss or damage to your item(s) during transit, EatOut shall not be responsible for the same.

EatOut and the PDP shall have the right to deny performance of Task(s) where it is not possible for the PDP to transfer the item(s) from the pick-up location to the drop-off location due to the big volume of the item(s).

You understand and agree that the recipient of the item(s) should be available at the drop-off location at time communicated for delivery of the item(s). In the event the recipient is not available at the drop-off location or refuses to take delivery or cannot be located by the PDP, you will receive a notification either through App and/ SMS and/ or a phone call (“Non-acceptance Message”). On receipt of Non-acceptance Message, it shall be your responsibility to take re-delivery of the item(s) at your location on payment of additional cost which may be communicated by EatOut. In the event you refuse to pay the cost of re-transportation or re-delivery of the item(s) for which a Non-acceptance Message has been sent to you, you hereby authorize EatOut and/the PDP to hold the item(s) in lieu of its claim of re-transportation of the item(s) and subject to payment of the said amount release the item(s) in your favour. In the event you fail to act in the matter and take re-delivery of the item(s) from the PDP, within the reasonable time especially in case perishable goods or goods with limited shelf life, you hereby waive all your claims to such item(s) and declare that EatOut or the PDP shall not be liable for any loss or damage caused or suffered, to the item(s), whether directly or indirectly.

Please refer to the Cancellation and Refund Policy for cancellation and refunds terms in relation to usage of the Platform for availing Services.  
EatOut - User Terms & Conditions for EatOut DineOut Services
...
The terms and conditions of use and privacy policy that apply to your access or use of EatOut websites, mobile sites, and applications (collectively, the Platform) is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 and may be accessed through the hyperlinks provided in the para below on EatOut Policies.

In addition, when you access or use the Platform, its content, features, and services for making payments and availing Offers (as defined below) as part of the EatOut DineOut Services provided by EatOut on its Platform (the DineOut Services), you will be subject to terms, guidelines and conditions applicable to DineOut Services. (T&C)

In this T&C, EatOut, we "us" or "our" mean the Bundl Technologies Private Limited, a private limited company incorporated under the Companies Act, 1956 and having its registered office at No.55, Sy No.8-14, Ground Floor, I&J Block, Embassy Tech Village, Outer Ring Road, Devarbisanahalli, Bengaluru – 560103, Karnataka, India, that is providing the DineOut Services to you, and with whom you are entering into this agreement. For the purpose of this T&C, wherever the context so requires, "you" or User shall mean any natural or legal person who is offered by EatOut to avail its EatOut DineOut Services on the Platform by providing registration data while registering on the Platform as a registered user using any computer systems.

This T&C incorporates EatOut's standard policies, procedures, and terms and conditions for use of the DineOut Services, including: (i) Terms of Use as provided under [https://www.EatOut.com/terms-and-conditions]; (ii) Privacy Policy as provided under [https://www.EatOut.com/privacy-policy]; (and (iii) and any other policies of the EatOut as may be referenced by name or by links in this T&C or otherwise detailed out in the Platform (collectively, the EatOut Policies).

By accessing or using the DineOut Services or by clicking accept or agree to this T&C, (1) you acknowledge that you have read, understand, and agree to be bound by this T&C, and (2) you represent and warrant that you are of legal age and not prohibited by law from accessing or using the DineOut Services (including, if applicable, purchasing, giving, using, or redeeming any offers provided by EatOut, which may include but not limited to any offers such as cash back, discount, free meal or beverage or sweet or gift, as per the discretion of EatOut and its onboarded restaurants partners. (Offers)

EatOut may update, amend or revise this T&C (including any EatOut Policies) from time to time. You agree that you will review this T&C and other EatOut Policies periodically. You are free to decide whether or not to accept a modified version of this T&C and other EatOut

Policies, but accepting this T&C and other EatOut Policies, as modified, is required for you to continue using the DineOut Services. You may have to click accept or agree to show your acceptance of any modified version of this T&C. If you do not agree to the terms of this T&C or any modified version of this T&C, you must either not use such DineOut Services or terminate your use of the DineOut Services, in which case you will no longer have access to DineOut Services. Except as otherwise expressly stated by EatOut, any use of the DineOut Services or availing of certain Offers provided by EatOut or the onboarded restaurants partners is subject to the version of the T&C in effect at the time of use.

EatOut DineOut Services
Under the EatOut DineOut Services, it allows its Users to avail certain Offers/benefits from authorised restaurants onboarded by EatOut on its Platform ("Restaurants"). Such Offers can be availed by the User at the time of making payment though the Platform. Payment may be made through the Platform and the User would be required to confirm with the restaurant that the payment has been cleared.

Upon Users availing the DineOut Services, whether or not as a subscribed member of EatOut, You will be entitled to avail discounts and Offers on the Invoiced Amount (as defined below) as determined by EatOut and/or the Restaurant and you shall pay the Invoiced Amount via the Platform as further detailed under Clause 4 (Payment), in accordance with these T&C and other EatOut Policies. For the purpose of this T&C, Invoiced Amount shall mean the total amount set out in the bill/invoice raised by the Restaurants for food and beverages ordered by the User at the Restaurants, and shall include applicable taxes, service charge and other charges as may be applicable. Any discounts applied shall be on the final Invoice Amount.

The User shall be permitted to access DineOut Service across different devices using their respective EatOut account credentials (i.e. username & password).

The Offers or benefits shall be extended only if the User makes payment towards the Invoiced Amount (as defined below) raised by the Restaurants for food and beverages ordered by the User at the Restaurants via the EatOut Platform.

EatOut at its own discretion may impose certain conditional limits on the number of times such Offer or benefits can be availed in a day by such User.

Any offers for home delivery may differ from Offers or benefits for dine out.

DineOut Services
Restaurant Offers.
EatOut will provide DineOut Services to the User through its Platform for the purpose of assisting and offering our User in making payments and availing discounts and/or other

Offers/benefits (as applicable) at authorised third-party Restaurant(s), as duly onboarded by EatOut.

User with EatOut DineOut Services will be entitled to avail certain Offers and benefits on the Invoiced Amount, as determined by EatOut and/or the Restaurant and you shall pay the Invoiced Amount via the Platform in accordance with these T&C and other EatOut Policies.

We do not however guarantee and are not responsible for the performance of the Restaurant (including their personnel or third party at their premises), the dining services, quality of food or beverage, which are the sole responsibility and are to be provided and/or otherwise performed by the Restaurant. We are therefore not responsible for the service, eligibility, or termination of the Restaurant. As provided above in these T&C, we may also terminate your use of the DineOut Services and/or your Account upon your committing fraud of any kind with regards to your obligation to pay EatOut or the Restaurant in full for services rendered.

We reserve the right to at any time without notice, change the terms applicable to DineOut Services, including the value, validity, expiration period, and/or your ability to redeem existing Offers or benefits.

Offers are applicable for DineOut only and cannot be used with delivery or take away.
...
Liability Limitation: Notwithstanding anything otherwise set out herein, EatOut shall in no manner be liable in any way for any in-person interactions with the Restaurant as a result of the User's experience at the Restaurant EatOut is only acting as a payment gateway platform and shall not be liable for any acts or omissions on part of the Restaurant including deficiency in service, quality of food, time taken to serve or any other experience of the User.

Contact Us: You may write to us at @legal@EatOut.in for any further queries with regard to the DineOut Services.

Offers & benefits.
Depending on your city or place of residence, you may be able to avail only certain Offers provided by EatOut and the relevant Restaurant, provided that, the User strictly complies with all the terms and conditions of EatOut and the relevant Restaurant partner. For the purposes of clarity, these Offers shall be subject to certain additional terms and conditions, such as the details of such Offer, their validity, etc. Such Offer terms may be changed or modified from time to time. Therefore, prior to availing any

Offers, it is your responsibility to review the terms and conditions governing such Offers/benefits provided by EatOut.

From time to time, EatOut may run marketing and promotional campaigns which may provide Offers and other promotional offers to be used on the Platforms.
...
EatOut reserves the right to void, discontinue or reject the use of any Offer without any prior notice.
...
may be changed or added from time to time. You are advised to check the Offer terms and conditions being offered by EatOut and/or the Restaurant at the time of placing your order;
...
can only be availed by Users who have subscribed to EatOut DineOut Services.
...
Communications from EatOut. If you use our Platform and/or DineOut Services, EatOut may communicate with you via electronic messages, including email, text message/SMS, or mobile push notifications in accordance with our privacy policy.
Personal Information. Users will be required to share certain personal information with EatOut and/or the Restaurant including but not limited to their name, phone number, email address in order to avail the DineOut Services and the User hereby permits EatOut to share such personal information with the Restaurant for confirming such User's booking and/or such other communication relating to but not limited to the DineOut Services or any promotions by the Restaurant. EatOut will use these details in accordance with the Privacy Policy published here.
Technical Requirements. Use of the DineOut Services requires Internet access through your mobile device. You are responsible for all mobile carrier data or text message charges resulting from your use of the DineOut Services, including from any notifications provided by the DineOut Services. In order to use the text message based services, you must maintain an active account with a carrier of electronic communications through mobile devices and you may not use a prepaid cellular phone to access such text message services. EatOut does not guarantee that the DineOut Services will be compatible with all devices or will be supported by all mobile carriers.
Modifications of DineOut Services. EatOut reserves the right, in its sole discretion, to modify the DineOut Services from time to time and without notice, including, without limitation, by removing, adding, or modifying portions of the DineOut Services or these T&C or Restaurants. EatOut shall have no liability to you for any of the foregoing actions. If you object to any such changes, your sole recourse shall be to cease using the DineOut Services. Continued use of the DineOut Services following any such changes shall indicate your acknowledgment of such changes and satisfaction with all the Services.
Intellectual Property Rights and Grant of Rights to User. The features, information, and materials provided and depicted through the DineOut Services are protected by copyright, trademark, patent, and other intellectual property laws. All text, graphical content, video, data, and other content made available through the DineOut Services (collectively, the EatOut Content) are provided to User by EatOut or its partners or licensors solely to support User's permitted use of the DineOut Services. The EatOut Content in the Platform or DineOut Services or these T&C may be modified from time to time by EatOut in its sole discretion. Except as expressly set forth herein, no license is granted to User for any other purpose, and any other use of the DineOut Services or the EatOut Content by User shall constitute a material breach of this T&C. EatOut and its partners (including Restaurants) or licensors retain all rights in the DineOut Services and EatOut Content and any associated patents, trademarks, copyrights, mask work rights, trade secrets, or other intellectual property rights. No license, right, or interest in any trademarks of EatOut or any third party is granted under this T&C.
Applicability of other EatOut Policies: You hereby agree that at all times, this T&C shall be read in conjunction with the other terms and conditions of the EatOut Policies.
Termination. EatOut may suspend your ability to use all or any element of the DineOut Services or may terminate this agreement effective immediately, without notice or explanation. Without limiting the foregoing, EatOut may suspend your access to the DineOut Services if we believe you to be in violation of any part of this T&C (including any EatOut Policies). After any suspension or termination, you may or may not be granted permission to use the DineOut Services or re-establish an Account. You agree that EatOut shall not be liable to you for any suspension or termination of this agreement or for any effects of any termination of this agreement. You are always free to discontinue your use of the DineOut Services at any time. You understand that any termination of your Account may involve deletion of any content stored in your Account for which EatOut will have no liability whatsoever.
Liability Limitations. EXCEPT AS EXPRESSLY SPECIFIED HEREIN, IN NO EVENT SHALL EatOut BE LIABLE FOR ANY INJURIES, LOSSES, CLAIMS, OR DIRECT DAMAGES OR ANY SPECIAL, EXEMPLARY, PUNITIVE, INCIDENTAL, OR CONSEQUENTIAL DAMAGES OF ANY KIND, WHETHER BASED IN CONTRACT, TORT, OR OTHERWISE, AND EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES, WHICH ARISE OUT OF OR ARE ANY WAY CONNECTED WITH (1) THIS T&C (INCLUDING ANY CHANGES THERETO), (2) ANY USE OF THE EatOut PLATFORM, DINEOUT SERVICES, THE EatOut CONTENT, OR THE USER CONTENT, (3) ANY FAILURE OR DELAY (INCLUDING, BUT NOT LIMITED TO, THE USE OR INABILITY TO USE ANY COMPONENT OF ANY OF THE SERVICES), OR (4) YOUR VISIT TO ANY RESTAURANT OR THE PERFORMANCE, NON-PERFORMANCE, CONDUCT, OR POLICIES OF ANY RESTAURANT OR MERCHANT IN CONNECTION WITH THE SERVICES. IN ADDITION, YOU SPECIFICALLY UNDERSTAND AND AGREE THAT ANY THIRD PARTY DIRECTING YOU TO THE EatOut SITE BY REFERRAL, LINK, OR ANY OTHER MEANS IS NOT LIABLE TO USER FOR ANY REASON WHATSOEVER, INCLUDING, BUT NOT LIMITED TO, DAMAGES OR LOSS ASSOCIATED WITH THE USE OF THE SERVICES OR THE EatOut CONTENT. EatOut IS NEITHER AN AGENT OF NOR OTHERWISE ASSOCIATED WITH ANY RESTAURANT FOR WHICH A USER HAS MADE A RESERVATION, CLAIMED AN OFFER OR PROMOTION, OR PAID A BILL USING THE PAYMENT SERVICES.
IF THE DISCLAIMER OF DIRECT DAMAGES ABOVE IS NOT ENFORCEABLE AT LAW, EXCEPT AS OTHERWISE EXPRESSLY SET FORTH IN THE EatOut POLICIES, YOU EXPRESSLY AGREE THAT OUR LIABILITY TO YOU (FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION) WILL NOT EXCEED THE LAST FEE YOU PAID. THESE

EXCLUSIONS AND LIMITATIONS OF LIABILITY WILL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW AND WILL SURVIVE CANCELLATION OR TERMINATION OF YOUR EatOut DINEOUT SERVICES.

These T&C are co-extensive and concurrent with other EatOut Policies listed on their Platform. As such, all other terms and conditions listed hereinbefore shall also be applicable to this EatOut DineOut Services and the same need not be expressly repeated herein.

You and EatOut understand and agree that the aforementioned disclaimers, exclusions, and limitations are essential elements of this T&C and that they represent a reasonable allocation of risk. In particular, you understand that EatOut would be unable to make the DineOut Services available to you except on these terms and agree that this T&C will survive and apply even if any limited remedy specified in this T&C is found to have failed of its essential purpose.

Disclaimer of Warranties. YOU UNDERSTAND THAT USE OF THE DineOut SERVICES IS AT YOUR OWN RISK AND EatOut CANNOT GUARANTEE THAT THE DineOut SERVICES WILL BE UNINTERRUPTED OR ERROR-FREE. THE DineOut SERVICES, ALL EatOut CONTENT, AND ANY OTHER INFORMATION, PRODUCTS, AND MATERIALS CONTAINED IN OR ACCESSED THROUGH THE DineOut SERVICES, ARE PROVIDED TO USER ON AN AS IS BASIS AND WITHOUT WARRANTY OF ANY KIND. EatOut EXPRESSLY DISCLAIMS ALL REPRESENTATIONS, WARRANTIES, CONDITIONS, OR INDEMNITIES, EXPRESS OR IMPLIED, INCLUDING, WITHOUT LIMITATION, ANY WARRANTY OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE , TITLE, OR NON-INFRINGEMENT, OR ANY WARRANTY ARISING FROM A COURSE OF DEALING, PERFORMANCE, OR TRADE USAGE. EatOut DOES NOT WARRANT THAT YOUR USE OF THE DineOut SERVICES WILL BE UNINTERRUPTED OR ERROR-FREE, THAT EatOut WILL REVIEW THE INFORMATION OR MATERIALS MADE AVAILABLE THROUGH THE DineOut SERVICES FOR ACCURACY OR THAT IT WILL PRESERVE OR MAINTAIN ANY SUCH INFORMATION OR MATERIALS WITHOUT LOSS. EatOut SHALL NOT BE LIABLE FOR DELAYS, INTERRUPTIONS, SERVICE FAILURES, OR OTHER PROBLEMS INHERENT IN USE OF THE INTERNET AND ELECTRONIC COMMUNICATIONS OR OTHER SYSTEMS OUTSIDE THE REASONABLE CONTROL OF EatOut.
THE FOREGOING DISCLAIMERS APPLY TO THE MAXIMUM EXTENT PERMITTED BY LAW. YOU MAY HAVE OTHER STATUTORY RIGHTS. HOWEVER, THE DURATION OF STATUTORILY REQUIRED WARRANTIES, IF ANY, SHALL BE LIMITED TO THE MAXIMUM EXTENT PERMITTED BY LAW.

Applicable Law & Dispute Resolutions: These T&C shall be governed in accordance with the laws of India. All disputes related to the DineOut Services or EatOut DineOut Services will be subject to the exclusive jurisdiction of courts of Bangalore only.
Third-Party Websites, Applications and Services. The DineOut Services may contain hypertext links to websites and applications operated by parties (including the onboarded Restaurants) other than EatOut. Such hypertext links are provided for User's reference only, and EatOut does not control such websites and is not responsible for their content. EatOut's inclusion of any hypertext links to such websites or applications does not imply any endorsement of the material on such websites or applications or any association with their operators. EatOut assumes no liability whatsoever for any such third-party websites, applications or any content, features, products, or services made available through such third-party websites or applications.
Release. Restaurants are solely responsible for their interactions with you and any and all claims, injuries, illnesses, damages, liabilities, and costs (Claims) suffered by you as a result of your (or such recipient's) interaction with or visit to any Restaurant or merchant or from any promotion, offer, product or service of any Restaurant or Merchant. Users must resolve all disputes directly with Restaurants. To the maximum extent permitted by applicable law, you hereby release EatOut from any and all such Claims.
...
Assignment. This Agreement and the rights granted and obligations undertaken hereunder may not be transferred, assigned, or delegated in any manner by User, but may be freely transferred, assigned, or delegated by EatOut.
...
You shall at all times be responsible for the use of the Services through your computer or mobile device and for bringing these Terms of Use and EatOut policies to the attention of all such persons accessing the Platform on your computer or mobile device.
...
You agree and grant permission to EatOut to receive promotional SMS and e-mails from EatOut or allied partners. In case you wish to opt out of receiving promotional SMS or email please send a mail to support@EatOut.in.
...
You will not discriminate against any Merchants, Buyers or PDPs based on race, religion, caste, national origin, disability, sexual orientation, sex, marital status, gender identity, age or any other metric which is deemed to be unlawful under applicable laws. Any credible proof of such discrimination, including any refusal to provide or receive goods or services based on the above metrics, whether alone or in conjunction with any other metric, whether lawful or unlawful, shall render you liable to lose access to the Platform immediately. You will not have any claim towards, and we will not have any liability towards any termination which is undertaken as a result of the aforementioned event.
...
You release and fully indemnify EatOut and/or any of its officers and representatives from any cost, damage, liability or other consequence of any of the actions of the Users of the Platform and specifically waive any claims that you may have in this behalf under any applicable laws of India. Notwithstanding its reasonable efforts in that behalf, EatOut cannot take responsibility or control the information provided by other Users which is made available on the Platform. You may find other User's information to be offensive, harmful, inconsistent, inaccurate, or deceptive. Please use caution and practice safe trading when using the Platform.
...
You and we acknowledge that these Terms of Use are concluded between you and EatOut only, and not with an Operator, and we, not those Operators, are solely responsible for the Platform and the content thereof to the extent specified in these Terms of Use.
...
EatOut DISCLAIMS AND ALL LIABILITY THAT MAY ARISE DUE TO ANY VIOLATION OF ANY APPLICABLE LAWS INCLUDING THE LAW APPLICABLE TO PRODUCTS AND SERVICES OFFERED BY THE MERCHANT OR PDP.
...
You recognize that EatOut is the registered owner of the word mark ‘EatOut’ and the logo  including but not limited to its variants (IPR) and shall not directly or indirectly, attack or assist another in attacking the validity of, or EatOut’s or its affiliates proprietary rights in, the licensed marks or any registrations thereof, or file any applications for the registration of the licensed marks or any names or logos derived from or confusingly similar to the licensed marks, any variation thereof, or any translation or transliteration thereof in another language, in respect of any products/services and in any territory throughout the world. If you become aware or acquire knowledge of any infringement of IPR you shall report the same at brand-protection@EatOut.in with all relevant information.
...
EatOut has put in place IP Notice and Take Down Policy (" Take Down Policy") so that intellectual property owners could easily report listings that infringe their right to ensure that infringing products are removed from the site, as they erode Buyer and good Seller trust.
...
Note: EatOut does not and cannot verify that Merchants have the right or ability to sell or distribute their listed products or services. However, EatOut is committed to ensure that item listings do not infringe upon intellectual property rights of third parties once an authorized representative of the rights owner properly reports them to EatOut.
...
EatOut One and EatOut One Lite Membership Program Specific Terms
Effective from 30th August 2023

These are the terms and conditions ("Terms") for EatOut One or EatOut One Lite ("EatOut One or EatOut One Lite") membership program and offered by EatOut to its Users on the Platform. These Terms shall govern your use of our service offered under EatOut One or EatOut One Lite Membership Program. Please read these Terms carefully before you subscribe to the EatOut One or EatOut One Lite Program. These Terms are subject to modifications, to comply with a legal requirement. You have the following options under the EatOut One or EatOut One Lite membership program and you can choose from these options at your sole discretion basis the suitability.

EatOut One or EatOut One Lite Plans: (Please refer your EatOut App for plan details)
The distances from the restaurant location to the customer's location shall be captured as per Google Map driving directions data at the time of placing the Order. EatOut shall not be held responsible or liable for the accuracy or efficacy of such data.
The EatOut One or EatOut One Lite benefits are available to orders above a certain amount. Please check FAQs for more details.
Additional discounts specific to the EatOut One or EatOut One Lite Programme will be applicable on the discounted values of the food items post application of any generally available coupons on the Platform.
With EatOut One, users will pay no delivery fee on Instamart orders above Rs 199. Number of free deliveries depends on subscription.
With EatOut One, users will get a discount of 10% on the applicable delivery fee for all Genie orders. With EatOut One Lite, users will get a discount of 10% on the applicable delivery fee for all Genie orders above Rs 60.


Subscription Fee, Payment and Activation:
EatOut shall charge and You agree to pay such membership fee, as may be determined by EatOut from time to time. You can use Credit Card, Debit Card, Net Banking, EatOut Money and the other available third-party payment options to subscribe to the EatOut One program or EatOut One Lite program. However, Cash on Delivery (COD) payment option can be used to subscribe to the EatOut One program only when clubbed together with the placed Order. The subscription shall be activated upon successful payment through the EatOut Platform. In case EatOut One or EatOut One Lite membership is purchased along with an Order and if such Order is canceled, then the membership shall also stand cancelled and the EatOut One or EatOut One Lite membership subscription amount will be refunded. You can access the detailed FAQs in the Help Section.


No Cancellation or Termination:
EatOut One or EatOut One Lite membership once purchased, cannot be cancelled or Terminated in the effective period of the membership.


Modification/ Cancellation of membership by EatOut
EatOut may cancel or modify Your EatOut One or EatOut One Lite membership at its sole discretion without notice. If we do so, we will issue a prorated refund based on the number of full months remaining in your EatOut One or EatOut One Lite membership. However, we will not give any refund for cancellation of EatOut One or EatOut One Lite membership related to conduct that we determine, in our sole discretion, violates these Terms, the Privacy Policy or any applicable law, or any conduct that we in our sole capacity decide involves fraud or misuse of the EatOut One or EatOut One Lite Membership, or is harmful to our interests or another user, participating restaurant or any delivery executive. Our failure to insist upon or enforce your strict compliance with these Terms will not constitute a waiver of any of our rights.


Important notice:
These Terms are special terms and as such restricted to only Buyer Orders placed through EatOut on participating restaurants when You are a EatOut One or EatOut One Lite Member and as such does not supersede the EatOut Terms of Use, unless specifically called out here. We reserve the right to modify these Terms at any time without notice posting changes on the Platform and you shall be responsible to update yourself of such changes, if any, by accessing the changes on the Platform. Your continued usage of the EatOut One or EatOut One Lite Program after any change is posted constitutes your acceptance of the amendments.


General Terms & Conditions:
We reserve the right to accept or refuse membership in our sole discretion
We may send you an email, or other communication related to EatOut One or EatOut One Lite Membership (regardless of any settings or preferences related to your EatOut account).
You may not transfer or assign your EatOut One or EatOut One Lite Membership or any EatOut One or EatOut One Lite benefits, except as allowed in these Terms.
From time to time, We may choose in our sole discretion to add or remove EatOut One or EatOut One Lite Membership benefits.
...
EatOut reserves the right to offer this EatOut One or EatOut One Lite membership in select cities and on select restaurants, at its sole discretion.
EatOut One or EatOut One Lite Membership feature is available only on the App.
Free deliveries are applicable only on food Orders for participating restaurants, on Instamart Orders and on EatOut Mall Orders, subject to the minimum order amounts as enumerated under the relevant Platform Services interface being met by You.
EatOut One or EatOut One Lite membership can be used only on 2 devices at a time. EatOut One or EatOut One Lite membership is priced for individual and personal usage. Having a 2 device limit reduces the instances of misuse. This will ensure that we are able to serve our members in the most optimal way while still maintaining fair usage within reasonable parameters. This ensures that we continue to make the membership affordable for all consumers and sustainable for EatOut.


Dineout Coupon:
Holders of EatOut One membership can now also avail additional benefits in the form of Dineout coupons, which can be redeemed by You exclusively on the Dineout Services being provided by Us on the Platform. The following are the terms and conditions governing the same:
During the tenure of Your EatOut One membership, You will be eligible to receive 2 (two) Dineout coupons, worth INR 150 each, for each month you continue as a EatOut One member.
These self-serve coupons are being extended as an additional benefit to our EatOut One members and exclusive of all other benefits associated with EatOut One membership.
These coupons can only be redeemed by You for bills paid by You via our Dineout Services on the Platform. The coupons cannot be redeemed or exchanged in any other way, including by way of cash with any of our restaurant partners.
One coupon can be availed only on one restaurant bill with a minimum order value of INR 1500. Both coupons cannot be clubbed towards payment of one restaurant bill.
These coupons will be valid per membership month, that is, if a user purchases a 3 (three) month membership on June 15, 2 (two) coupons will be issued every month till September 15. In the above example, coupon validity periods will be:
2 coupons from June 15 to July 15;
2 coupons from July 16 to August 15; and
2 coupons from August 16 to September 15.
Once the EatOut one membership expires, the allocation of 2 (two) monthly coupons to you shall cease. The same will be resumed once You renew Your EatOut One membership.


EatOut Money:
For EatOut Money users (applicable to the users who have created the wallet with ICICI before June 30, 2023): You agree and acknowledge that, for any positive balance remaining in the EatOut Money powered by ICICI, you have or will receive the Gift Card of equivalent amount from EatOut and once the gift card is received by you, there shall be no further concerns regarding the amount in EatOut Money.


Limitation of Liability
IN ADDITION TO OTHER LIMITATIONS AND EXCLUSIONS IN EatOut'S CONDITIONS OF USE AND SALE, IN NO EVENT WILL WE OR OUR DIRECTORS, OFFICERS, EMPLOYEES, AGENTS OR OTHER REPRESENTATIVES BE LIABLE FOR ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY OTHER DAMAGES OF ANY KIND, ARISING OUT OF OR RELATED TO EatOut. OUR TOTAL LIABILITY, WHETHER IN CONTRACT, WARRANTY, TORT (INCLUDING NEGLIGENCE) OR OTHERWISE, WILL NOT EXCEED THE LAST MEMBERSHIP FEE YOU PAID. THESE EXCLUSIONS AND LIMITATIONS OF LIABILITY WILL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW AND WILL SURVIVE CANCELLATION OR TERMINATION OF YOUR EatOut ONE MEMBERSHIP.

All disputes related to this EatOut One Membership will be subject to the exclusive jurisdiction of courts of Bangalore only.

These Terms and Conditions are co-extensive and concurrent with EatOut's other Terms and Conditions and the Privacy Policy listed on this Platform. As such, all other Terms and Conditions listed hereinbefore shall also be applicable to this EatOut One Membership and the same need not be expressly repeated herein.
...
Identification of the material that is claimed to be infringing or to be the subject of infringing activity and that is to be removed or access to which is to be disabled, and information reasonably sufficient to permit EatOut to locate the material;

Information reasonably sufficient to permit EatOut to contact the complaining party, such as an address, telephone number, and, if available, an email address at which the complaining party may be contacted;
...
Send the written communication to: Email to grievances@EatOut.in
...
No. 17/9B, 4th Floor, Maruthi Chambers,

Rupena Agrahara, Hosur Road, Bangalore – 560 068
...
(Important Note: (a) EatOut shall be unable to process requests which do not specify exact product IDs or URLs. Please do not provide links to browse pages or links of search queries as these pages are dynamic and their contents change with time. (b) EatOut shall not consider an incomplete request. (c) EatOut's response to such request will include removing or disabling access to material claimed to be the subject of infringing activity. For a detailed term of use of our Platform, please visit https://www.EatOut.com/terms-and-conditions).
